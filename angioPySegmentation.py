    ...
    with tab1:
        ...
        with col1:
            ...
            if isCalibMode:
                ...
                fig_calib.update_layout(height=512, margin=dict(l=0, r=0, t=0, b=0), dragmode=False, hovermode=False)
                fig_calib.update_traces(hovertemplate=None, hoverinfo='skip')
                ...
                fig_annot.update_layout(height=512, margin=dict(l=0, r=0, t=0, b=0), dragmode=False, hovermode=False)
                fig_annot.update_traces(hovertemplate=None, hoverinfo='skip')
